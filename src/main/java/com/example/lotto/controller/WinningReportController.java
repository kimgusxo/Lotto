...
public class WinningReportController {
    ...
    public ResponseEntity<WinningReportDTO> getByRound(@PathVariable Integer round) {
    ...
    @GetMapping("/get/date")
    public ResponseEntity<List<WinningReportDTO>> getByDate(@RequestParam LocalDate startDate,
    ...
    public ResponseEntity<List<WinningReportDTO>> getByTotalWinningAmount(@PathVariable Long totalWinningAmount) {
        List<WinningReportDTO> winningReportDTOList = winningReportService.readByTotalWinningAmount(totalWinningAmount);
        return new ResponseEntity<>(winningReportDTOList, HttpStatus.OK);
    }

    @PostMapping("/post/insert")
    public ResponseEntity<WinningReportDTO> insert(@RequestBody WinningReportDTO winningReportDTO) {
    ...
    public ResponseEntity<WinningReportDTO> update(@PathVariable Integer round,
                                                   @RequestBody WinningReportDTO winningReportDTO) {
